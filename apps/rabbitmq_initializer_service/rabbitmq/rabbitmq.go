...
func (rmqM RabbitmqManager) InitializeProjectRabbitMq() error {
	...
	if err != nil {
		rmqM.l.Error(errors.New("failed to declare exchange with the name: " + rmqM.cfg.SharedConfig.Rabbitmq.UserExchangeName))
		return err
	}
